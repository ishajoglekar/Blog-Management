                        ...
                        <div class="form-group">
                          <div class="row">
                            <div class="col-md-6 m-10">
                              ...
                              <input type="text" class="form-control <?= $errors != '' ? ($errors->has('name') ? 'error is-invalid' : '') : ''; ?>" name="name" id="name" placeholder="Enter Post Name" value="<?= $old != '' ? $old['name'] : ''; ?>">
                            ...
                            <div class="col-md-12 m-10">
                              ...
                              <textarea type="text" class="form-control <?= $errors != '' ? ($errors->has('content') ? 'error is-invalid' : '') : ''; ?>" name="content" id="content" placeholder="Enter Content" rows="10"><?= $old != '' ? $old['content'] : ''; ?></textarea>
