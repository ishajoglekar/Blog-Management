...
$navSection = "dashboard";
  ...
  $user_details = $di->get('user')->getUserByID($user_id,PDO::FETCH_ASSOC);
                              ...
                              <div class="col-md-12">
                                <div class="form-group">
                                  ...
                                  <input type="text" 
                                    ...
                                    value="<?= $old != '' ?$old['first_name']: $user_details[0]['first_name'];?>"
                                  >
...
<div class="col-md-6 m-10">
                                  ...
                                  <input type="text" 
                                    ...
                                    value="<?= $old != '' ?$old['last_name']: $user_details[0]['last_name'];?>"
                                  >
                                ...
                                if($errors!="" && $errors->has('last_name')):
                                  ...
                                  <input type="text" 
                                    ...
                                    value="<?= $old != '' ?$old['email']: $user_details[0]['email'];?>"
                                  >
                                ...
                                if($errors!="" && $errors->has('email')):
                                  ...
                                  <input type="text" 
                                    ...
                                    value="<?= $old != '' ?$old['username']: $user_details[0]['username'];?>"
                                  >
                                ...
                                <option value="0" <?php if($user_details[0]['authority'] == "0"):?>selected <?php endif;?>>User</option>
                                 <option value="1" <?php if($user_details[0]['authority'] == "1"):?>selected <?php endif;?>>Admin</option>
                                </select>
                                <?php
                                ...
                                ?>
                                  ...
                                  <?php
                                if($errors!="" && $errors->has('authority')):
                                  echo "<span class='error'> {$errors->first('authority')}</span>";endif;
                                  ?>
                                  </div>
