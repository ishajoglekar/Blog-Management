            ...
            <div class="p-5">
              ...
              <form class="user" action="<?=BASEASSETS?>../helper/routing.php" method="POST" id="register">
                ...
                <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user <?= $errors!= '' ? ($errors->has('first_name') ? 'error is-invalid' : '') : '';?>"
                     id="first_name" placeholder="First Name"
                     value = "<?= $old != '' ?$old['first_name']: '';?>" name="first_name">
                     <?php
                  ...
                  <div class="col-sm-6">
                  <input type="text" class="form-control form-control-user <?= $errors!= '' ? ($errors->has('last_name') ? 'error is-invalid' : '') : '';?>"
                     id="last_name" placeholder="Last Name"
                     value = "<?= $old != '' ?$old['last_name']: '';?>" name="last_name" >
                     <?php
                    if($errors!="" && $errors->has('last_name')):
                      echo "<span class='error'> {$errors->first('last_name')}</span>";endif;
                      ?>
                  </div>
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                  <input type="text" class="form-control form-control-user <?= $errors!= '' ? ($errors->has('email') ? 'error is-invalid' : '') : '';?>"
                     id="email" placeholder="Email Address"
                     value = "<?= $old != '' ?$old['email']: '';?>"  name="email">
                     <?php
